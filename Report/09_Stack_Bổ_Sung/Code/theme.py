...
def get_css(theme: dict) -> str:
    ...
    .social-icons {{ display: flex; justify-content: center; gap: 2rem; padding: 1rem 0; }}
    .social-icon {{
    ...
    .stTabs [data-baseweb="tab-list"] {{
        display: flex; flex-wrap: nowrap; justify-content: space-between; gap: 10px; width: 100%;
    ...
    .stTabs [data-baseweb="tab"] {{
        flex: 1 1 auto; min-width: 110px; height: 44px; padding: 0 16px;
        border-radius: 12px; color: var(--muted); background: transparent;
    ...
    button[data-testid="baseButton-secondary"] {{
        ...
        font-family: 'Inter', sans-serif !important;
        transition: all 0.3s ease !important;
        box-shadow: 0 4px 15px color-mix(in oklab, var(--accent) 25%, transparent) !important;
    ...
    .stCodeBlock, [data-testid="stCodeBlock"], .stMarkdown pre, div[data-testid="stMarkdownContainer"] pre {{
        background: rgba(255,255,255,0.08) !important;
        border: 1px solid rgba(255,255,255,0.15) !important;
        border-radius: 10px !important;
    }}
    .stCodeBlock code, [data-testid="stCodeBlock"] code, .stMarkdown pre code, div[data-testid="stMarkdownContainer"] pre code {{
